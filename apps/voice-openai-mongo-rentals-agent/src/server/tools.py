...
def rentlas_search_tool(query: str, k: int = 5):
    """
    Perform a vector similarity search using MongoDB MongoDB Vector Search to find rentals.
    ...
    Note:
        Uses MongoDB MongoDB Vector Search for semantic search capabilities.
    """
